...
export class TrajetoriaPortfolioComponent {
  ...
  timeline: TimelineItem[] = [
    { year: '2026', title: 'Fiscalização das Obras de Restauro no Palácio Joaquim Nabuco (ALEPE)', description: 'Supervisão técnica de 8 pavimentos na Assembleia Legislativa de Pernambuco, garantindo conformidade normativa e excelência na execução.', icon: 'project', imageUrl: 'https://i.ibb.co/d0XN61CV/alepe-fachada-frontal-480x600.jpg' },
