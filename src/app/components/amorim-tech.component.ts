    ...
    <div class="w-full bg-slate-50 py-6 sm:py-10 lg:py-16 px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-14 lg:space-y-16">
      <div class="max-w-7xl mx-auto space-y-10 sm:space-y-14 lg:space-y-16">
        ...
        <section class="text-center max-w-3xl mx-auto space-y-3 sm:space-y-4">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-50 border border-cyan-200/80 text-cyan-700 text-[10px] sm:text-xs font-semibold tracking-wide shadow-sm">
          ...
          <div class="relative bg-slate-900 text-white rounded-3xl p-5 sm:p-8 lg:p-10 shadow-2xl border border-slate-800 text-center space-y-5 sm:space-y-7 overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center space-y-3 sm:space-y-4">
              <div class="flex items-center gap-3">
                ...
                <div class="text-left">
                  <span class="block text-[10px] sm:text-[11px] font-extrabold uppercase tracking-widest text-cyan-400">
        ...
        <section class="space-y-6 sm:space-y-8 lg:space-y-10" id="alo-sindico">
          ...
          <div class="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 border border-amber-200/80 text-amber-800 text-[10px] sm:text-xs font-semibold tracking-wide shadow-sm">
          ...
          <div class="max-w-4xl mx-auto">
            <div class="bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl p-5 sm:p-8 lg:p-10 text-white text-center shadow-lg space-y-4 sm:space-y-6">
              <div class="space-y-2">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/10 backdrop-blur-xs text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider">
                  <span>⚡</span>
        ...
        <section class="space-y-6 sm:space-y-8 lg:space-y-10">
          <div class="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-200/80 text-indigo-700 text-[10px] sm:text-xs font-semibold tracking-wide shadow-sm">
