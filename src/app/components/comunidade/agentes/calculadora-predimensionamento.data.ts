...
export const SISTEMAS_CALCULAVEIS: SistemaCalculavel[] = [
  ...
  {
    id: 'spda-descidas-np1-np2',
    tipologiaId: 'spda-protecao-contra-raios-e-aterramento',
    nome: 'SPDA — Número de Descidas (Nível de Proteção I ou II)',
    ...
    observacao: 'Espaçamento de 10 m entre descidas, igual para NP I e NP II (perímetro ÷ 10 m). Mínimo de 2 descidas mesmo se o cálculo apontar menos. Tolerância de 20% no espaçamento é permitida, desde que não reduza o número calculado.',
    fonte: 'NBR 5419-3:2026, Tabela 5 (item 5.4.3.1) — confirmado que a edição 2026 manteve os espaçamentos da edição 2015 sem alteração; auditoria realizada em 31/08/2026.',
  },
  {
    id: 'spda-descidas-np3',
    tipologiaId: 'spda-protecao-contra-raios-e-aterramento',
    nome: 'SPDA — Número de Descidas (Nível de Proteção III)',
    categoria: 'Sistemas de Incêndio',
    tipoCalculo: 'divisor',
    campos: [{ id: 'perimetro', label: 'Perímetro da edificação', unidade: 'm', placeholder: 'Ex: 60' }],
    divisor: 15,
    unidadeResultado: 'descidas',
    formatoResultado: unidadeInteira,
    observacao: 'Espaçamento de 15 m entre descidas para NP III (perímetro ÷ 15 m). Mínimo de 2 descidas mesmo se o cálculo apontar menos. Para NP IV, o espaçamento é 20 m — consulte a Tabela 5 completa da norma.',
    fonte: 'NBR 5419-3:2026, Tabela 5 (item 5.4.3.1) — confirmado que a edição 2026 manteve os espaçamentos da edição 2015 sem alteração; auditoria realizada em 31/08/2026.',
  },
  {
    id: 'exaustao-garagem',
